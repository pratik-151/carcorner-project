...
class Car(models.Model):
    ...
    def thumbnail_preview(self):
        if self.car_photo:
            _thumbnail = get_thumbnail(self.car_photo,
                                   '70x70',
                                   upscale=False,
                                   crop=False,
                                   quality=100)
            return format_html('<img src="{}" width="{}" height="{}" style="border-radius:20%;">'.format(_thumbnail.url, _thumbnail.width, _thumbnail.height))
        return ""
